  ...
  return (
    <li className="relative" x-data="{ dropdownOpen: false, notifying: true }">
      <Link
        ...
        className="relative flex h-8.5 w-8.5 items-center justify-center rounded-full border-[0.5px] border-stroke bg-gray hover:text-primary dark:border-strokedark dark:bg-meta-4 dark:text-blue-gray-50"
        to="#"
      >
        ...
        <ul className="flex h-auto flex-col overflow-y-auto">
          <li>
            ...
            >
              ...
              <div>
                <h6 className="text-sm font-medium text-black dark:text-blue-gray-50">
                  Mariya Desoja
                </h6>
