    ...
    <>
      ...
      >
        <Card className="mx-auto w-full max-w-[100rem] ">
          ...
          <section className="flex items-center bg-gray-100 overflow-y-auto scrollbar max-h-[40rem]">
            <div className="justify-center flex-1 max-w-6xl px-4 py-4 mx-auto mt-90 md:mt-0">
              <div>
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="flex flex-col items-start justify-center w-full pb-4 space-y-4">
                          ...
                          <div className="flex justify-center items-center">
                            ...
                            <p className="ml-1 text-base leading-4 break-all inline-flex rounded-full bg-danger bg-opacity-10 py-1 px-3 font-medium text-danger">
                              Renting
                            </p>
                          </div>
                        </div>
