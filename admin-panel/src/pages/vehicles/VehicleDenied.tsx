...
import {
  deleteVehicleDeniedAsync,
  getVehiclesDeniedAsync,
...
export default function VehiclePending() {
  ...
  useEffect(() => {
    if (
      ...
      if (modelsParam !== "") {
        ...
        dispatch(setVehicleDeniedParams({ Models: modelsFilter }));
      } else {
      ...
      if (collectionsParam !== "") {
        ...
        dispatch(setVehicleDeniedParams({ Collections: collectionsFilter }));
      } else {
        setSearchParams((prev) => {
      ...
      if (brandsParam !== "") {
        ...
        dispatch(setVehicleDeniedParams({ Brands: brandsFilter }));
      } else {
        setSearchParams((prev) => {
          prev.delete("Brands");
          return prev;
      ...
      if (citiesParam !== "") {
        ...
        dispatch(setVehicleDeniedParams({ Cities: citiesFilter }));
      } else {
        setSearchParams((prev) => {
          prev.delete("Cities");
          return prev;
  ...
  useEffect(() => {
    if (pageSize === "5") {
      ...
      dispatch(setVehicleDeniedParams({ pageSize: 5 }));
    } else {
      ...
      dispatch(setVehicleDeniedParams({ pageSize: pageSizeCurrent }));
    }
  }, [pageSize, dispatch]);
  ...
  useEffect(() => {
    if (!vehiclesDeniedLoaded) {
      ...
      } else if (searchParams.size === 0 && vehiclesDenied.length === 0) {
        dispatch(getVehiclesDeniedAsync());
      }
    }
