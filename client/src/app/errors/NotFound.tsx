        ...
        <div className="flex-1 min-h-full min-w-full rounded-3xl bg-white shadow-xl p-10 lg:p-20 text-gray-800 relative md:flex items-center text-center md:text-left">
          <div className="w-full flex flex-col items-center justify-center md:items-start md:w-1/2">
            ...
            <div className="mb-10 md:mb-20 text-gray-600 font-normal">
              <h1 className="font-black uppercase text-3xl lg:text-5xl text-orange-based mb-10">
                You seem to be lost!
              </h1>
              <p>The page you're looking for isn't available.</p>
            </div>
            <div className="mb-20 md:mb-0">
              <button className="text-xl px-2 font-bold outline-none focus:outline-none transform transition-all hover:scale-110 text-orange-based/90 hover:text-orange-based">
                Go Back
              </button>
            </div>
          </div>
