  ...
  return (
    <>
      {/* <section className="bg-image">
        <div className="block max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16">
          <div className="mr-auto place-self-center ">
            <h1 className="mb-4 text-4xl font-extrabold tracking-tight leading-none md:text-5xl xl:text-6xl dark:text-white">
              Self-ride motorcycle rental
            </h1>
            <p className="mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">
              The value proposition of MotorMate is its ability to connect
              travelers with credible motorcycle rental suppliers. Users can
              find and book the motorcycle they wish to rent effortlessly with
              only a few clicks using MotorMate, without worrying about the
              reliability of the rental service vendors.
            </p>
            <a
              href="#"
              className="inline-flex items-center justify-center px-5 py-3 mr-3 text-base font-medium text-center text-black rounded-lg bg-[#5bd043] hover:bg-lime-500 focus:ring-4 focus:ring-primary-300 dark:focus:ring-primary-900"
            >
              Get started
              <svg
      ...
      <div className="cover-page px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16">
        ...
        <div className="content">
          ...
          <a href="#">Be a Lessor motorcycles</a>
        </div>
      </div>
