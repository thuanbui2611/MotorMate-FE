        ...
        <div className="relative mb-20 h-96">
          ...
          <div className="absolute bottom-0 left-0 flex items-center">
            <div className="relative">
              ...
              <label
                htmlFor="profile"
                className="absolute bottom-0 right-4 flex -mb-14 lg:right-6 lg:-mb-20 h-8.5 w-8.5 cursor-pointer items-center justify-center rounded-full p-1 lg:p-2 bg-blue-500 text-white"
              >
                <svg
