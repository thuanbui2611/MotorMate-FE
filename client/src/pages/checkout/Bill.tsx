...
export default function Bill() {
  return (
    <>
      ...
      <section className="flex items-center pb-16 bg-gray-100 md:pb-20 font-poppins ">
        <div className="justify-center flex-1 max-w-6xl px-4 py-4 mx-auto bg-white border rounded-md  md:py-10 md:px-10">
          <div>
            ...
            <div className="flex flex-wrap items-center pb-4 mb-10 border-b border-gray-200 ">
              ...
              <div className="w-full px-4 mb-4 md:w-1/4">
                <p className="mb-2 text-sm leading-5 text-gray-600  ">Date: </p>
                <p className="text-base font-semibold leading-4 text-gray-800 ">
                  March 18, 2022
                </p>
              </div>
            ...
            <div className="flex flex-wrap items-center justify-start gap-4 px-4 mt-6 ">
              <button className="w-full px-4 py-2 text-blue-500 border border-blue-500 rounded-md md:w-auto hover:text-gray-100 hover:bg-blue-600 ">
                Go back shopping
              </button>
              <button className="w-full px-4 py-2 bg-blue-500 rounded-md text-gray-50 md:w-auto  hover:bg-blue-600 ">
                View career details
              </button>
            </div>
          </div>
