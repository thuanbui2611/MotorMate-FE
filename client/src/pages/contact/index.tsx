              ...
              <div className="max-w-sm mx-auto ">
                <div className="p-6 mb-6 text-center bg-white border rounded-md shadow dark:border-gray-800 dark:bg-gray-800">
                  <form action="">
                    ...
                    ></textarea>
                    <button className="w-full py-4 text-sm font-bold leading-normal text-white transition-all duration-300 bg-gradient-to-r from-[#FF6003] to-[#FF7E06] rounded-md hover:bg-orange-based">
                      Send Message
                    </button>
                  </form>
                </div>
            ...
            <div className="max-w-2xl px-4 mb-16 lg:mb-0 lg:w-1/2 lg:mr-0 lg:ml-auto">
              ...
              <div className="flex mb-6 text-gray-400 ">
                <svg
                  ...
                  height="16"
                  fill="currentColor"
                  className="text-gray-600 w-7 h-7 bi bi-telephone "
                  viewBox="0 0 16 16"
                >
                ...
                <div className="max-w-xl ml-4 text-lg font-semibold tracking-wide text-gray-500 ">
                  <span> +84 999999999 ,</span> <span> +84 888888888</span>
                </div>
              </div>
