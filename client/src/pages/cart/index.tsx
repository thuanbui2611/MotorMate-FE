                                    ...
                                    >
                                      <div className="flex flex-col items-center justify-center">
                                        ...
                                        <div className="relative flex items-center justify-center">
                                          ...
                                          vehicle.vehicleId ? (
                                            <div
                                              className="text-xs font-semibold bg-blue-500 cursor-pointer text-white absolute -bottom-[42px] rounded-full py-[2px] px-2 w-fit text-center hover:bg-blue-700"
                                              onClick={() =>
